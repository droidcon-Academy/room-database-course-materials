...
@Composable
fun InvoiceCard(invoice: InvoiceWithItems, onClick: () -> Unit, onMenuClick: (menu: InvoiceMenu) -> Unit) {
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = context.toDateString(invoice.invoice.created_at),
            ...
            InvoiceMarker(isPaid = invoice.invoice.is_paid)
        }
    }
}
